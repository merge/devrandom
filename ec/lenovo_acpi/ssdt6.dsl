 ...
 *
 * Disassembly of ssdt6.dat, Thu Mar 14 15:14:21 2019
 *
...
DefinitionBlock ("", "SSDT", 1, "PmRef", "Cpu0Cst", 0x00003001)
{
    ...
    External (_SB_.PCI0.LPC_.EC__.HKEY.CKC4, UnknownObj)
    External (C3NA, UnknownObj)
    External (C6NA, UnknownObj)
    ...
    Scope (\_PR.CPU0)
    {
        ...
        Method (_CST, 0, Serialized)  // _CST: C-States
        {
            ...
            If ((CFGD & 0x1000) && (PDC0 & 0x0200))
            {
                ...
                {
                    If (((CFGD & 0x00010000) && !\C7NA) && !\_SB.PCI0.LPC.EC.HKEY.CKC4)
                    {
                        Zero
                        If (CFGD & 0x08)
                        {
                    ...
                    If (((CFGD & 0x20) && !\C7NA) && !\_SB.PCI0.LPC.EC.HKEY.CKC4)
                    {
                        Zero
                        If (CFGD & 0x08)
                        {
                    ...
                    If (((CFGD & 0x10) && !\C6NA) && !\_SB.PCI0.LPC.EC.HKEY.CKC4)
                    {
                        Zero
                        If (CFGD & 0x08)
                        {
